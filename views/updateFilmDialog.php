<!-- Add film dialog -->
<div class="modal fade" id="modal-update-film" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" style="color: #218838;">Modifier film</h5>
      ...
      <form id="form-update-film" action="javascript:void(0);" onsubmit="updateFilm();">
        ...
        <div class="modal-footer">
          ...
          <button type="reset" class="btn btn-danger" onclick="toggleDialog('#modal-update-film'); $('#error-update-film-dialog').hide();">Annuler</button>
        </div>
      </form>
    </div>
  </div>
